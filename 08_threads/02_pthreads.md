...
Библиотеката **pthreads** дефинира набор от типове, функции и константи на езика за програмиране C, които поддържат приложения с изисквания за множество потоци на контрол, наречени нишки, в рамките на един процес. 
