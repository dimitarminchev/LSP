...
В папка `libexample/` създайте файл `test.c` като използвате командата:
```
nano test.c
```
...
Компилирайте тестовата програма използвайки командата:
```
gcc test.c -ldl -o test
```

Стартирайте тестовата програма използвайки командата:
```
./test
```
