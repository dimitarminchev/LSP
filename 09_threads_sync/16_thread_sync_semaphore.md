...
Декларираме семафор (_Променлива: sem_). Декларираме баланс (_Променлива: balance_) и го инициираме с 1000. Дефинираме процедура при работа на нишката, която oбработва аргумента и освобождава семафора. Инициираме семафора със стойност нула (_Означава: Зает_). Стартираме първата нишка и предаваме параметър за сума на депозита (_Променлива: deposit_amount_). Стартираме втората нишка и предаваме параметър за сума на депозита (_Променлива: deposit_amount_). Изчакваме двете нишки да приключат своята работа и унищожаваме семафора.
