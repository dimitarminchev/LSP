...
Дефинираме променливи **mutex** и **balance**. Дефинираме на функция за нишки, където заключваме mutex. Добавяме сумата от депозита (_Променлива: deposit_) към баланса (_Променлива: balance_). Отпечатваме на баланса и отключваме на мютекса. Създаваме на първа нишка с депозит от 200, извеждаме съобщение при неуспех. Създаваме на втора нишка с депозит от 200, извеждаме съобщение при неуспех. Изчакваме двете нишки да приключта своята работа.
