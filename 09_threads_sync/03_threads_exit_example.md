...
Дефинираме функция за изход, която освобождава заетата памет. Дефинираме функция на нишката: Заключване на отмяната на нишката. Заемаме 1K памет и извеждаме съобщение. Добавяме манипулатор за почистване при изход от нишката, предаващ заетата памет като параметър. Отключваме отмяната на нишката. Отпечатваме 5 съобщения за 5 секунди. Извикваме и изпълняваме, манипулатора за почистване при изход от нишката.
